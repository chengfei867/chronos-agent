...
- **CrewAI adapter: eight rounds of zero code changes.** R52 scaffold still unmodified through R59 (R52→R59, i.e. R53 pin-bump + R54 spike13 + R55 live wrap + R56/R57 docs + R58 merge core + R59 compare CLI/API). The adapter-stability streak continues.
